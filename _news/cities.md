---
layout: post
title: Cities in Motion Workshop - Transportation Data Innovation Challenge
date: 2026-04-29
related_posts: true
tags: [event, news]
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/workshop-1400.webp" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/cities_in_motion-1400.webp" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
